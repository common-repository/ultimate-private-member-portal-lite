...
class UPMP_Posts{
	...
	public function __construct(){
		add_action('wp_ajax_upmp_load_published_posts', array($this, 'load_published_posts'));
        add_action('wp_ajax_upmp_load_published_pages', array($this, 'load_published_pages'));
        add_action('wp_ajax_upmp_load_published_cpt', array($this, 'load_published_cpt'));
